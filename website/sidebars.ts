...
const sidebars: SidebarsConfig = {
  docs: [
    ...
    },
    {
      type: 'category',
      label: 'New Guides',
      items: [{type: 'autogenerated', dirName: 'guides-new'}],
    },
    {
      type: 'category',
      label: 'Integrations',
      items: [{type: 'autogenerated', dirName: 'integrations-new'}],
    },
    {
      type: 'category',
      label: 'Runbooks',
      items: [{type: 'autogenerated', dirName: 'runbooks-new'}],
    },
    {
      type: 'category',
      label: 'Archive',
    ...
    },
    {
      type: 'category',
      label: 'Projects',
      items: [{type: 'autogenerated', dirName: 'projects-new'}],
    },
    {
      type: 'category',
      label: 'Portfolio',
      items: ['portfolio/portfolio-portfoli'],
    },
    {
      type: 'category',
